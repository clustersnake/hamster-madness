...
-- Nombres de las animaciones en el atlas
-- Ajusta estos nombres según tu player.atlas
local ANIMS = {
	idle_down = "idle_down",
	idle_up = "idle_up",
...
local function set_animation(self, anim_name, flip_x)
...
function M.update(self, is_init)
	...
	if is_init then
		...
		set_animation(self, ANIMS.idle_down, false)
		return
	end
...
function M.update_idle(self, dir, flip)
	...
	local anim = ANIMS["idle_" .. dir]
	set_animation(self, anim, flip)
